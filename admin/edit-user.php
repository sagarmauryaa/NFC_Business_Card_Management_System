...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form class="edit-profile" data-id="<?= base64_encode($id) ?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" class="form-control" id="slug" placeholder="Please Enter Slug" required="required" value="<?= $result[0]['slug'] ?>">
                            </div>
                            <div class=" form-group">
